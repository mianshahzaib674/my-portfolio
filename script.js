// Ensure Typed.js is properly initialized
var typed = new Typed('.typing', {
    strings: ["Frontend Developer", "Backend Developer", "Graphic Designer", "Youtuber", "Web Designer"],
    typeSpeed: 50,
    backSpeed: 25,
    loop: true,
});
...
function asideSectionTogglerBtn() {
    ...
    document.getElementById("showLessBtn").addEventListener("click", function() {
        document.getElementById("more-services").classList.add("hidden");
